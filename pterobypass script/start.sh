...
██         ██    ███████ ██   ██  ██████      ██████     ██    ██      ██   ██ ███████ ███████ 
   ...
   ${NC}
    "
    echo -e "${RED}Specify the principal folder ! (for example ./start.sh 25566 ${lightblue}/home/container)"
...
██         ██    ███████ ██   ██  ██████      ██████     ██    ██      ██   ██ ███████ ███████ 
   ...
   ${NC}
    ...
    echo -e "${RED}To start the ssh server (only if its running on another port) >> service dropbear start"
    echo "──────────────────────────────────────────────────────────────────────"
